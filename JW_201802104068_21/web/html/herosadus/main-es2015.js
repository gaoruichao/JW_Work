...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"hero\">\n  <h2>{{hero.description | uppercase}} Details</h2>\n  <div><span>id: </span>{{hero.description}}</div>\n  <div>\n    <label>description:\n      <input [(ngModel)]=\"hero.id\" placeholder=\"description\"/>\n    </label>\n  </div>\n  <button (click)=\"goBack()\">go back</button>\n  <button (click)=\"save()\">save</button>\n</div>\n");
...
/* harmony import */ var angular_in_memory_web_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! angular-in-memory-web-api */ "./node_modules/_angular-in-memory-web-api@0.9.0@angular-in-memory-web-api/index.js");
...
let HeroService = class HeroService {
    constructor(http, messageService) {
        ...
        // private heroesUrl = ':/base:api/heroes';   设计与后台结合  api换成servlet名称
        this.heroesUrl = 'school/listA.ctl';
    }
    ...
    deleteHero(hero) {
        ...
        const url = `${this.heroesUrl}/${id}`;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`deleted hero id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteHero')));
    }
    /** PUT: update the hero on the server */
    updateHero(hero) {
        return this.http.put(this.heroesUrl, hero, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`updated hero id=${hero.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateHero')));
    }
    /**
...
let HeroesComponent = class HeroesComponent {
    ...
    add(description) {
        ...
        this.heroService.addHero({ description })
            .subscribe(hero => {
...
module.exports = __webpack_require__(/*! D:\TIM下载文件\herosadus\src\main.ts */"./src/main.ts");
