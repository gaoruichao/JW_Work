        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SchoolService = /** @class */ (function () {
                function SchoolService(http) {
                    this.http = http;
                    this.collegeUrl = '../school/list.ctl'; //自己实际的service
                }
                ...
                SchoolService.prototype.getCollege = function (id) {
                    var url = this.collegeUrl + "/" + id;
                    return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getCollege data.id=" + id)));
                };
                /**
